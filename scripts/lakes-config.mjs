...
export const LAKES = [
  ...
  { slug: "travis", name: "Lake Travis", city: "Austin", location: "near Austin, Texas", featured: true },
  ...
  { slug: "canyon", name: "Canyon Lake", city: "New Braunfels", location: "near New Braunfels, Texas", featured: true },
  { slug: "choke-canyon", name: "Choke Canyon Reservoir", city: "Corpus Christi", location: "near Corpus Christi, Texas" },
  { slug: "conroe", name: "Lake Conroe", city: "Houston", location: "near Houston, Texas", featured: true },
  ...
  { slug: "ray-roberts", name: "Lake Ray Roberts", city: "Dallas", location: "near Dallas, Texas", featured: true },
  ...
  { slug: "caddo", name: "Caddo Lake", city: "East Texas", location: "on the Texas-Louisiana border — a National Natural Landmark", featured: true },
  ...
  { slug: "texoma", name: "Lake Texoma", city: "Sherman-Denison", location: "on the Texas-Oklahoma border", featured: true },
